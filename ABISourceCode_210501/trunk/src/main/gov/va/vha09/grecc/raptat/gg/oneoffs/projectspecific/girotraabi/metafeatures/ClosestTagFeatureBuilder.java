...
public class ClosestTagFeatureBuilder extends MetaFeatureBuilder {
  ...
  {
    this.removalTagDescriptors = new ArrayList<>();
    this.removalTagDescriptors.add(new TagPatternDescriptor("Row", "Col", "Doc"));
    this.removalTagDescriptors.add(new TagPatternDescriptor("Before"));
    this.removalTagDescriptors.add(new TagPatternDescriptor("Phrases"));
  }
  ...
  public void buildFeatures(final Collection<RaptatTokenPhrase> phrases) {
    ...
    for (final RaptatTokenPhrase tokenPhrase : phrases) {
      ...
      /*
       * Stores the TextPatternDescriptor pattern and the phraseFeature that matches the entire list
       * of patterns. This should
       */
      ...
      for (final String phraseFeature : tokenPhraseFeatures) {
        ...
        Optional<Pattern> indexPatternOptional =
            findFeatureSegment(phraseFeature, this.indexTagDescriptors.patternSet);
  ...
  private Optional<Pattern> findIndexTag(final String phraseFeature) {
    return findFeatureSegment(phraseFeature, this.indexTagDescriptors.patternSet);
  }
  ...
  private Optional<RaptatPair<List<Pattern>, Integer>> findRemovalTags(String phraseFeature) {
    ...
    for (final TagPatternDescriptor textDescriptor : this.removalTagDescriptors) {
