 ...
 */
public class RaptatDocument
    implements Comparable<RaptatDocument>, Serializable, IRaptatDocumentTokenPhrases {
  ...
  public class MetaData {
    ...
    public String toString() {
      return MessageFormat.format("MetaData: ({0},{1})", getName(), this.value);
    }
  ...
  public RaptatDocument(final List<AnnotatedPhrase> theSentences,
      ...
      final IndexedTree<IndexedObject<RaptatToken>> allProcessedTokens, final String pathToSource) {
    this();
    ...
    this.textSource = new File(this.textSourcePath).getName();
  }

  public RaptatDocument(final RaptatDocumentFields rdf) {
    this.textSource = rdf.textSource;
  }
  ...
  public MetaData getMetaData(final String metaDataKey) {
    if (this.metaDataMap == null || this.metaDataMap.containsKey(metaDataKey) == false) {
  ...
  public String getRawTextInRange(final int startOffset, final int endOffset) {
    ...
    while (curOffset < endOffset) {
      if ((curTokenObject = this.rawTokens.getClosestLesserOrEqualObject(curOffset)) == null
          && (curTokenObject = this.rawTokens.getClosestGreaterObject(curOffset)) == null) {
        return resultBuffer.toString();
      }

      curToken = curTokenObject.getIndexedObject();
      resultBuffer.append(curToken.getTokenPreprocessedSubstring(startOffset, endOffset));
  ...
  /**
   * Find the processed tokens between start and end offsets within the document
   *
   * @param start
   * @param end
   * @return
  ...
  public List<RaptatToken> getSpannedTokens(final int start, final int end) {
    GeneralHelper.errorWriter("getSpannedTokens() method in RaptatDocument class not implemented");
    return null;
  }
  ...
  public String getTextSourcePath() {
  ...
  public List<RaptatToken> regenerateProcessedTokens(final boolean removeStopWords,
    ...
    List<RaptatToken> allDocumentTokens = new ArrayList<>(RaptatConstants.TOKENS_PER_DOCUMENT);
  ...
  public void setDocumentLines(final List<TextDocumentLine> textDocumentLines) {
  ...
  public void setListOfColumnsOfPhrases(final List<DocumentColumn> documentColumns) {
   ...
   */
  public void setTextSourcePath(final String textSourcePath) {
    this.textSourcePath = textSourcePath;
    this.textSource = new File(textSourcePath).getName();
  }
