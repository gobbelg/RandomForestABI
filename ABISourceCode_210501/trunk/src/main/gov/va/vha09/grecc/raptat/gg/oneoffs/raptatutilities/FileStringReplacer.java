...
public class FileStringReplacer {
  ...
  public static final String TEXT_FILEPATH =
      "C:\\Users\\gobbelgt\\Documents\\SubversionMatheny\\branches\\GlennWorkspace\\Projects\\RaptatBaseProject\\resources\\exampleForRegexStringReplacement.txt";
  public static final String REGEX_FILEPATH =
      "C:\\Users\\gobbelgt\\Documents\\SubversionMatheny\\branches\\GlennWorkspace\\Projects\\RaptatBaseProject\\resources\\exampleRegexes_190410.txt";
  ...
  public static void main(String[] args) {
    ...
    SwingUtilities.invokeLater(new Runnable() {
      ...
      public void run() {
        ...
        PrintWriter pw = null;
        try {
          File replacementFile = getReplacementFile(textFile);
      ...
      private File getReplacementFile(File textFile) {
        ...
        return new File(parentDirectoryPath, textFileNameOnly[0] + "_Replaced.txt");
      }
      ...
      private List<RaptatPair<String, String>> getReplacementRegexesAndStrings(File regexFile) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(regexFile))) {
          ...
          while ((textLine = br.readLine()) != null) {
            ...
            ++line;
            resultSet.add(new RaptatPair<>(regexReplacementPair[0], regexReplacementPair[1]));
          }
        } catch (IOException exception) {
          exception.printStackTrace();
        }
